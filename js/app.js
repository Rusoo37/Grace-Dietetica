...
let Productos = [
    ...
    { id: 21, categoria: 4, nombre: "Quinoa", descripcion: "La quinoa se considera una fuente de proteína de calidad y de alto valor biológico", precio: 400, img: "https://d3ugyf2ht6aenh.cloudfront.net/stores/001/157/846/products/quinoa1-f5c2e42d92a1bc1b2b15871712588385-640-0.webp" },
    { id: 22, categoria: 4, nombre: "Sesamo", descripcion: "El sesamo es una especie originaria de India y África y antiguamente era utilizado por su alto contenido en óleo.", precio: 150, img: "https://www.cocinista.es/download/bancorecursos/ingredientes/ingrediente-sesamo.jpg" }
]
...
TAREAS:
    1- EMAIL SUSCRIPCION salta cartel de se ha subcrito para ofertas (Sweet Alert) -->
